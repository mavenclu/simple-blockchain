package cz.cvut.fel.omo.simpleblockchain;

import cz.cvut.fel.omo.simpleblockchain.block.Block;
...
import cz.cvut.fel.omo.simpleblockchain.node.farmer.SmallFarmer;
...
//        genesisTransaction.generateSignature(coinbase.privateKey);	 //manually sign the genesis transaction
    ...
    /*
    check the hash variable is actually equal to the calculated hash,
